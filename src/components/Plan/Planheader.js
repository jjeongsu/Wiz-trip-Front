    ...
    return (
        <P.HeaderWrapper>
            <div className='left-container'>
                {/* 여행개요 */}
                {updateform? (
                    <UpdatePlanInfo setUpdateForm={setUpdateForm} planinfo={planinfo} setPlanInfo={setPlanInfo}/>
                ):(
                    <P.PlanInfoLayout onClick={()=>{setUpdateForm(true)}}>
                    <span className='text-container'>{planinfo.location}</span>
                    <div className='vertical-line'/>
                    <span className='text-container'>{startDate} ~ {endDate}</span>
                    <div className='vertical-line'/>
